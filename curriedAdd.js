...
const addFirst = curriedAdd(1); // Перший аргумент: 1
const addSecond = addFirst(2);   // Другий аргумент: 2
const result = addSecond(3);     // Третій аргумент: 3, повертає 1 + 2 + 3

console.log('Result:', result);   // Виведе: 6
